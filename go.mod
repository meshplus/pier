...
require (
	...
	github.com/meshplus/bitxhub-core v0.1.0-rc1.0.20210426064313-1039402a1957
	...
	github.com/meshplus/go-bitxhub-client v1.0.0-rc4.0.20210426053615-e5c3acf7e76d
